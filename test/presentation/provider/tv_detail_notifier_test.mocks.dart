...
import 'package:tv_series/domain/usecases/get_tv_watchlist_status.dart' as _i12;
import 'package:tv_series/domain/usecases/remove_tv_watchlist.dart' as _i11;
import 'package:tv_series/domain/usecases/save_tv_watchlist.dart' as _i10;
...
class MockSaveTvWatchlist extends _i1.Mock implements _i10.SaveTvWatchlist {
  ...
  _i2.TvRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeTvRepository_0()) as _i2.TvRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(_i7.TvDetail? detail) =>
